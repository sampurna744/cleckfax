...
if(isset($_POST["forgot"]))
{
    ...
    // Check if email exists
        if (emailExists($email) === "true") {
            ...
            $sql = "SELECT user_id, first_name, last_name FROM CLECK_USER WHERE user_email = :email";
            ...
            if ($row = oci_fetch_assoc($stmt)) {
                ...
                // Prepare the SQL statement
                    ...
                    if (oci_execute($stmt)) {
                        ...
                        header("Location:trader_password_reset_email.php?email=$email&userid=$user_id");
                        exit;
                    } else {
