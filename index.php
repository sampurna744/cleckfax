...
// Sort products by AVG_REVIEW_SCORE and select top 4
usort($products_review, function($a, $b) {
    return $b['AVG_REVIEW_SCORE'] <=> $a['AVG_REVIEW_SCORE'];
});
$selected_indices = array_slice(array_keys($products_review), 0, min(4, count($products_review)));
...
<body>
    ...
    <nav class="navbar is-light" role="navigation" aria-label="main navigation">
        <div class="navbar-brand">
            <a class="navbar-item logo-container" href="index.php">
                <img src="logo.png" alt="Cleckfax Logo" class="header-logo">
            </a>
    ...
    <section class="section our-traders">
        ...
        <p class="has-text-centered">Our traders are industry experts committed to sourcing premium products locally, ensuring quality and reliability at every step.</p>
        ...
        <div class="container">
            <div class="columns">
                <div class="column is-half">
                    ...
                    <p>Email: <a href="mailto:info@Cleckfax Traders.com">info@cleckfaxtraders.com</a></p>
                    <p>Phone: <a href="tel:+16466755074">646-675-5074</a></p>
                    <p>3961 Smith Street, West Yorkshire, England</p>
                    <div class="buttons mt-4">
                        <a href="https://www.facebook.com/Cleckfax Traders" class="button is-small" target="_blank">
                            <span class="icon"><i class="fab fa-facebook-f"></i></span>
                        </a>
                        <a href="https://www.twitter.com/Cleckfax Traders" class="button is-small" target="_blank">
                            <span class="icon"><i class="fab fa-twitter"></i></span>
                        </a>
                        <a href="https://www.instagram.com/Cleckfax Traders" class="button is-small" target="_blank">
