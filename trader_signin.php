    ...
    if (oci_execute($stmt)) {
        ...
        if ($row = oci_fetch_assoc($stmt)) {
            ...
            if ($password == $passwords && $user_role == "trader" && $status == 1) {
                ...
                $error_message = "You are not a registered trader at Cleckfax Traders.";
            } else {
...
<body>
    ...
    <div class="sign-in-container">
        ...
        <div class="action-links">
            ...
            <p>Wanna Be A Trader At Cleckfax Traders? <a href="trader_signup.php" class="sign-up-link">Sign Up</a></p>
