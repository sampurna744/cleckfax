...
function sendInvoiceEmail($order_id, $user_id) {
    ...
    try {
        ...
        $mail->Username   = 'Cleckfax Traders@gmail.com'; // SMTP username
        ...
        $conn = oci_connect('Cleckfax Traders', 'Root123#', '//localhost/xe'); 

        // Recipients
        $mail->setFrom('Cleckfax Traders@gmail.com', 'Cleckfax Traders');
        ...
        $mail->addReplyTo("Cleckfax Traders@gmail.com", "Cleckfax Traders");
        ...
        // Content
        $mail->isHTML(true);
        $mail->Subject = 'Cleckfax Traders INVOICE';
        ...
        <head>
            ...
            <title>Cleckfax Traders Invoice</title>
        </head>
        <body style='font-family: Arial, sans-serif; text-align: center;'>
            ...
            <!-- Heading -->
            <h2 style='color: #333;'>Cleckfax Traders Invoice</h2>
        
            <h3 style='text-align: center; font-size: 20px;'>Thank you <b style='text-transform: uppercase;'>$name</b> for Choosing Cleckfax Traders<br>Here is your Invoice Detail </h3>
        ...
        $mail->Body .= "
            ...
            <p style='text-align: center;'><b>Hope your cart was as full as your heart. Come back soon! Cleckfax Traders<b></p>

            <!-- Thank you message -->
            <p style='color: #666;'>If you have any questions or concerns regarding your order, feel free to contact us at <a href='mailto:contact@Cleckfax Traders.com' style='color: #007bff;'>contact@Cleckfax Traders.com</a>.</p>
