    ...
    try {
        ...
        $mail->Body    = "
                            ...
                            <body style='font-family: Arial, sans-serif; text-align: center;'>
                                ...
                                <!-- Text -->
                                <p style='color: #666; margin-bottom: 20px;'>Thank you $name for registering with Cleckfax Traders. Please verify your email address to complete the registration process.</p>
                                ...
                                <!-- Thank you message -->
                                <p style='color: #666;'>Thank you for registering with Cleckfax Traders. For any queries, please contact us at <a href='mailto:contact@Cleckfax Traders.com' style='color: #007bff;'>contact@Cleckfax Traders.com</a>.</p>
