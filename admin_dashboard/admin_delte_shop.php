...
if (isset($shop_id)) {
    ...
    try {
        ...
        // Delete from CLECK_USER table where USER_ID matches
        $deleteHudderUserSql = "DELETE FROM CLECK_USER WHERE USER_ID = :user_id";
        ...
        if (!$deleteHudderUserSuccess) {
            ...
            throw new Exception("Failed to delete from CLECK_USER table: " . htmlentities($e['message']));
        }
