...
$sql_count_customers = "SELECT COUNT(USER_ID) AS CUSTOMER_COUNT FROM CLECK_USER WHERE USER_TYPE = 'customer'";
...
$sql_count_traders = "SELECT COUNT(USER_ID) AS TRADER_COUNT FROM CLECK_USER WHERE USER_TYPE = 'trader'";
