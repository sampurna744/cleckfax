...
<head>
    ...
    <link rel="stylesheet" href="admin_view_shop_detail.css">
    <!-- swiper css file web -->
        ...
        <div class="right-div">
            <form id="shopDetailsForm" class="shop-details-form" name="shopDetailsForm" method="POST" action="" enctype="multipart/form-data">
                ...
                <div class="form-row">
                    ...
                    <button id="cancelBtn" class="cancel-btn" onclick="window.location.href='admin_shop_detail.php' ; return false;">Cancel</button>
                </div>
            </form>
        </div>
    </div>
