    ...
    if (oci_execute($stmt)) {
        ...
        if ($row = oci_fetch_assoc($stmt)) {
            ...
            if ($password ==  $passwords && $user_role == "customer" && $status == 1) {
                ...
                $user_role_error = "You are not a registered customer at Cleckfax Traders.";
            } else {
...
<body>
    ...
    <div class="sign-in-container">
        ...
        <div class="action-links">
            ...
            <p>New to Cleckfax Traders? <a href="customer_signup.php" class="sign-up-link">Sign Up</a></p>
